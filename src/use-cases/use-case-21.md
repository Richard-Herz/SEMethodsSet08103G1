# USE CASE: 21 Produce a Report on the top N populated countries in a region where N is provided by the user
...
We know the role.  Database contains country and region data.

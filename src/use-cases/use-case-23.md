# USE CASE: 23 Produce a Report on the top N populated countries in the world where N is provided by the user
...
3. **Data does not exist**:
    1. Population Information Worker advisor informs population analyst data doesn't exist.
